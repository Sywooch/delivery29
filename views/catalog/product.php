	...
	<div class="panel panel-default">
	  <div class="panel-body">
	    <p class="ptitle"><?php echo $data->name;?></p>
	  	...
	  	<button class="btn btn-primary bold-text btn-wide btn-space-top" onclick="addToChart(<?php echo $data->id?>)"><span class="hidden-xs">В корзину</span><span class="visible-xs-inline glyphicon glyphicon-plus"></span> <?php echo $data->price?> руб.</button>
	  </div>
	</div>
</div>
